...
from qtapp_example_dockable import viewmodel
from qtapp_example_dockable.view import item as view_item
from qtapp_example_dockable import view
...
class Window(QtWidgets.QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        self.info_action = self.right_toolbar.addAction("Info")
