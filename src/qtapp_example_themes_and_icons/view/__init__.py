...
from qtapp_example_themes_and_icons import viewmodel, model
...
class _InfoWidget(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.button = QtWidgets.QPushButton("Add to cart", self)
        self.button.setProperty("color", "primary")
        self.button.setProperty("bg-color", "secondary")
